...
import newRouteFormContextReducer, {
    actions as act,
} from './NewRouteFormContextReducers/NewRouteFormContextReducer.js';
...
function NewRouteFormContextProvider(props) {
    const initialState = {
        ...
        midPoints: [],
        transitMatrix: { pickup: [{ dropOff: [0, 0] }, { dropOff: [0, 0] }] },
        fare: {
            origin: 0,
            via: 0,
        },
